...
namespace ClashRoyaleWarTracker.Application.Interfaces
{
    ...
    {
        Task<bool> AddPlayerWarHistoriesAsync(List<PlayerWarHistory> playerWarHistories, string? updatedBy);
        ...
        Task<bool> UpdatePlayerWarHistoryAsync(int warHistoryId, int fame, int decksUsed, int boatAttacks, string? updatedBy);
