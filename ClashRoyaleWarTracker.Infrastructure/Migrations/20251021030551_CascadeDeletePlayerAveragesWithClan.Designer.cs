...
namespace ClashRoyaleWarTracker.Infrastructure.Migrations
{
    ...
    [Migration("20251021030551_CascadeDeletePlayerAveragesWithClan")]
    partial class CascadeDeletePlayerAveragesWithClan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClashRoyaleWarTracker.Application.Models.RosterAssignment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SeasonID", "WeekIndex");

                    b.HasIndex("ClanID", "SeasonID", "WeekIndex");

                    b.HasIndex("SeasonID", "WeekIndex", "PlayerID")
                        .IsUnique();
