...
namespace ClashRoyaleProject.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarTrophies = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClanHistories", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ClanHistories_Clans_ClanID",
                        column: x => x.ClanID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerAverages", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClanHistories_ClanID_SeasonID_WeekIndex",
                table: "ClanHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerAverages_ClanID",
                table: "PlayerAverages",
                column: "ClanID");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerAverages_PlayerID_Is5k",
                table: "PlayerAverages",
                columns: new[] { "PlayerID", "Is5k" },
                unique: true);
